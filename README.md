...
- 左右按钮 / 键盘方向键 / 触屏滑动翻页；
- 左上角 🏠 回到书架；页码旁 ⏮ 回到本书第一页；🔗 分享当前分类或故事的链接；⚙️ 设置（气泡停留时间、字号）；
- 自动记住每本书上次读到的页码。

## 分享链接

打开某个分类或某本故事后，地址栏会变成可分享的链接（也可以点标题旁的 🔗，弹出链接再复制或发给家人）：

- 某一类：`index.html#/original`（自编故事）、`#/classic`（经典童话）、`#/ai`、`#/ink`、`#/en`
- 某一本：`index.html#/original/gu-du-de-xiao-pang-xie`（分类 id / 故事 id）

网站放到网上以后，把完整网址发给别人即可；对方打开会直接进入对应分类或故事。分类芯片和封面本身也是链接，可以右键复制。
...
| 故事 | 页数 | 简介 |
|---|---|---|
| 动物王国开大会 | 20 页 | 按家里玩偶画的长篇：河水被巨石堵住，陆地、海洋、天空的朋友齐心协力把它疏通 |
| 五一和水塔 | 10 页 | 按家里两只小狗画的：黄狗五一和竖耳朵的水塔不怕泥泞去救小猫 |
| 台风白海豚 | 10 页 | 按家里玩偶画的：卷毛预报台风，大家齐心开直升机救人 |
| 动物城大救援 | 12 页 | 蓝蓝、灰灰、卷毛遇上龙卷风和地震，和朱迪、尼克、树懒闪电一起救人 |
| 孤独的小螃蟹 | 12 页 | 小青蟹去找更好的地方住，小螃蟹敲墙却再也听不到回应 |

**水墨中国故事**

| 故事 | 页数 | 简介 |
|---|---|---|
| 神笔马良 | 8 页 | 水墨风。马良用神笔画牛、画井，智退贪心的财主 |
| 三个和尚 | 8 页 | 水墨风。一个和尚挑水，三个和尚没水，大火让他们学会齐心 |
| 孔融让梨 | 8 页 | 水墨风。孔融把大梨让给哥哥和爸爸。告诉我们：要谦让，尊重长辈，关爱兄弟姐妹 |
| 铁杵磨成针 | 8 页 | 水墨风。小李白看见老奶奶把铁杵磨成针。告诉我们：只要坚持，难事也能做成 |
| 司马光砸缸 | 8 页 | 水墨风。小朋友掉进水缸，司马光砸缸救人。告诉我们：遇到危险要冷静想办法 |
| 寒号鸟 | 8 页 | 水墨风。寒号鸟把做窝拖到明天，冬天挨了冻。告诉我们：今天能做的事不要拖 |
...
| 农夫和金鱼 | 10 页 | 妻子一次次向金鱼要更多，最后全失去了。告诉我们：不要贪婪，要知足 |
